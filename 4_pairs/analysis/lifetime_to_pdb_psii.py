...
dict = { 
    ...
    "input_pdb": [f"{pdb_dir}/{{case}}/FINAL/final_aligned.pdb", f"{pdb_dir}/{{case}}_cofactors_cg.pdb", f"{pdb_dir}/{{case}}/FINAL/final_aligned.pdb"],
    ...
    "output": [f"{odir}/{{case}}_protein.pdb", f"{odir}/{{case}}_cofactors.pdb", f"{odir}/{{case}}_psbs.pdb"]
}
